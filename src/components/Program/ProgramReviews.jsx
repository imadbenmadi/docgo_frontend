...
const ProgramReviews = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true);
      const res = await reviewsAPI.submitProgramReview(programId, {
        rate: rateValue,
        comment,
      });
    ...
    >
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          placeholder={t(
            "reviews.shareExperienceProgram",
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      <h3 className="text-xl font-bold text-gray-900 mb-6">
        {t("reviews.studentReviews", "Student Reviews")}
      </h3>
      ...
      {totalReviews > 0 ? (
        ...
        <div className="text-center py-8 text-gray-400">
          ...
          <p className="text-gray-500">{t("reviews.noReviews", "No reviews yet")}</p>
          <p className="text-sm">
            {t("reviews.beFirstProgram", "Be the first to review this program!")}
          </p>
        </div>
      )}
